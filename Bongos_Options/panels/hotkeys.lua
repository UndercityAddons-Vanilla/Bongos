--[[
	visibility.lua
		Scripts for the Hotkeys panel of the Bongos Options menu
--]]
...
function BOptionsHotkeys_OnMousewheel(scrollframe, direction)
	local scrollbar = getglobal(scrollframe:GetName() .. "ScrollBar")
	scrollbar:SetValue(scrollbar:GetValue() - direction * (scrollbar:GetHeight() / 2))
	BOptionsHotkeysScrollBar_Update()
end

function BOptionsHotkeys_OnLoad()
...
function BOptionsHotkeys_OnShow()
	list = {}
...
function BOptionsHotkeysScrollBar_Update()
