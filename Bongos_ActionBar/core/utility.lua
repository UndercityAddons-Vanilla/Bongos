...
function BActionSets_HotkeysShown()
	return not(BActionSets and BActionSets.g.hideHotkeys)
end
...
function BActionSets_GetRangeColor()
	local rangeColor = BActionSets.g.rangeColor
	if rangeColor then
		return rangeColor.r, rangeColor.g, rangeColor.b
	end
end

function BActionSets_RightClickSelfCasts()
	return BActionSets.g.rightClickSelfCast
end

function BActionSets_SetRightClickSelfCast(enable)
	if enable then
		BActionSets.g.rightClickSelfCast = 1
	else
		BActionSets.g.rightClickSelfCast = nil
	end
end